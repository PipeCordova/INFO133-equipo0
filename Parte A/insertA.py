...
def medio_prensa():
    ...
    fundacion = input("Ingrese la fecha de fundación (YYYY-MM-DD): ").strip()
    ...
    if(id_medio != "" and nombre_medio != "" and cobertura != "" and id_ubi != ""):
        cur.execute("INSERT INTO medio_prensa (id_medio, nombre, fundacion, cobertura, id_ubi) VALUES (%s, %s, %s, %s, %s)", (id_medio, nombre_medio, fundacion, cobertura, id_ubi))
        print("SE HA INGRESADO CORRECTAMENTE\n")
    else:
...
def red_social():
    ...
    nombre_red_social = input("Ingrese el nombre de la red social (Instagram, Facebook, etc): ").title().strip()
    cuenta_red_social = input("Ingrese el nombre de la cuenta en la red social (@nombrecuenta): ").strip()
...
def noticia():
    ...
    xp_fecha = input("Ingrese la fecha de la noticia: ").strip()
    xp_titulo = input("Ingrese el título de la noticia: ").strip()
    xp_contenido = input("Ingrese el contenido de la noticia: ").strip()
